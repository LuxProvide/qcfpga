...
"""
import qcfpga
from qcfpga.backend import Backend
...
class State:
    ...
    def apply_gate(self, gate, target):
        ...
        Args:
            gate (~qcfpga.Gate): The gate to be applied to the register
    ...
    # Gates
    def h(self, target):
        self.apply_gate(qcfpga.gate.h(), target)

    def x(self, target):
        self.apply_gate(qcfpga.gate.x(), target)

    def y(self, target):
        self.apply_gate(qcfpga.gate.y(), target)

    def z(self, target):
        self.apply_gate(qcfpga.gate.z(), target)

    def s(self, target):
        self.apply_gate(qcfpga.gate.s(), target)

    def t(self, target):
        self.apply_gate(qcfpga.gate.t(), target)

    def sqrt_x(self, target):
        self.apply_gate(qcfpga.gate.sqrt_x(), target)

    def cx(self, control, target):
        self.apply_controlled_gate(qcfpga.gate.x(), control, target)

    def cnot(self, control, target):
        self.apply_controlled_gate(qcfpga.gate.x(), control, target)

    def toffoli(self, control, control2, target):
        self.apply_controlled_controlled_gate(qcfpga.gate.x(), control, control2, target)
    ...
    def u(self, target, theta, phi, lda):
        ...
        self.apply_gate(qcfpga.Gate(gate_matrix), target)
    ...
    def cu(self, control, target, theta, phi, lda):
        ...
        self.apply_controlled_gate(qcfpga.Gate(gate_matrix), control, target)
